...
export const fairQualityFoods: FoodCategory = {
  keywords: [
    ...
    'honey', 'maple syrup', 'peanut butter', 'cheese', 'energy drink',
...
export const goodQualityFoods: FoodCategory = {
  keywords: [
    ...
    // Hydration
    'water', 'coconut water', 'herbal tea', 'green tea'
  ],
...
export function getFoodRecommendations(
  ...
  if (lastMealQuality === 'poor') {
    recommendations.unshift('⚠️ Your last meal was low quality - make this one count!');
  }
...
console.log(`Food database initialized with ${totalKeywordCount} keywords`);